...
describe('App', () => {
  ...
  it('renders worktree metadata, clean status, and stop/remove actions', async () => {
    ...
    expect(screen.getByText('Worktree: /repo/one/.claude/worktrees/abc123')).toBeInTheDocument();
    expect(screen.getAllByText('Source: /repo/one').length).toBeGreaterThan(0);
    expect(screen.getAllByText('Branch: pin/abc123').length).toBeGreaterThan(0);
